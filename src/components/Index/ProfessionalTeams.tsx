    ...
    return (
        <div className="relative flex flex-col justify-center items-center gap-y-[12px] mt-[141px] z-10 w-full">
            ...
            <div className="flex lg:flex-row sm:flex-col lg:mt-[101.5px] lg:h-[626px] justify-center lg:items-start sm:items-center gap-x-[59px] w-full">
                <ExpertCard img="./Index/expert-1.png" title="Surgeon" name="Briyan Nevalli" description="Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit" />
                <ExpertCard main img="./Index/expert-2.png" title="Dermatologist" name="Bella sebastian" description="Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit" />
                <ExpertCard img="./Index/expert-3.png" title="Stylist expert" name="Lilly Adams" description="Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit" />
            </div>
        </div>
    )
}
