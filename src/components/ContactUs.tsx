function ContactUs() {
    return (
        <div>
            <div className="absolute contact-us mt-[-185px]">
            ...
            <div className="absolute contact-us mt-[-159px]">
            ...
            <div className="flex flex-wrap xl:flex-row sm:flex-col justify-center xl:items-start sm:items-center gap-x-[100px] xl:mt-[122.5px] pl-[20px] pr-[20px] sm:max-w-10/12 z-10">
                <img className="mt-[180px] z-10" src="/contact-us.svg" alt="" />
                <div className="flex flex-col justify-start z-10">
                    ...
                    <form action="submit" className="grid grid-cols-2 gap-x-[35.58px] gap-y-[38.32px] mt-[47px] md:max-w-[520px]">
                        ...
                        <Input className="pl-[27.5px]" type='text' placeholder="Last name" />
...
function Input({ type, placeholder, className }: { type: string, placeholder: string, className?: string }) {
    return (
        <input type={type} placeholder={placeholder} className={`${className} border border-outline text-base text-input-grey font-regular pl-[23px] pb-[3px] h-[61.58px] rounded-[15px] tracking-widest`} />
    )
}

function TextArea({ placeholder, rows, className }: { placeholder: string, rows: number, className?: string }) {
    return (
        <textarea placeholder={placeholder} rows={rows} className={`${className} border border-outline text-base text-input-grey font-regular pl-[23px] rounded-[15px] pt-[25.32px] tracking-widest`} />
    )
}
