    ...
    return (
        <div>
            <div className="absolute top-0 left-0 w-full h-full overflow-x-hidden">
                <div className="absolute z-10 intro-1">
                    <svg width="1267" height="743" viewBox="0 0 1267 743" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="relative flex md:flex-row sm:flex-col z-20 mt-[156px] ml-[35.5px] sm:pr-[35.5px] md:pr-0 justify-center items-start">
                <div className="flex flex-col z-20 mt-[56px]">
                    <h1 className="font-semibold text-5xl text-navy-blue leading-[125%] max-w-[430px]">Clinic & beauty consultant</h1>
                    <p className="font-medium text-base text-navy-blue max-w-[474px] tracking-widest mt-[8.5px]">It is a long established fact that a reader will be by the readable content of a page.</p>
                    <Button className="w-[200px] h-[58.36px] mt-[33.5px] pl-[3px] pb-[2.5px]" href="#" text="More Details" />
                </div>
...
function Dot({ active, onClick }: { active: boolean, onClick: () => void }) {
    return (
        <button onClick={onClick} className={`rounded-full ${active ? "w-[25.31px] h-[8.15px] bg-navy-blue" : "w-[14.82px] h-[3.09px] bg-light-grey mt-[-1px]"}`}></button>
    )
}
